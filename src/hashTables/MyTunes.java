...
public class MyTunes {
    ...
    public static void main(String[] args) {
        ...
        //final String TESTFILE01 = "resources/findIDs2.txt";    // Example test file for hashing based on IDs
        //final String TESTFILE02 = "resources/findGenres2.txt"; // Example test file for hashing based on genres names
        //final String TESTFILE01 = "resources/findIDs3.txt";    // Example test file for hashing based on IDs
        //final String TESTFILE02 = "resources/findGenres3.txt"; // Example test file for hashing based on genres names
